...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand fixed-top" style="background-color: #086623;">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar elevation-4" style="background-color: #086623;">
            <!-- Brand Logo -->
        ...
        <footer class="main-footer fixed-bottom">
            <strong>Copyright &copy; 2024 <a href="#">SMA AL-AZHAR 3 BANDAR LAMPUNG</a>.</strong>
            All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
