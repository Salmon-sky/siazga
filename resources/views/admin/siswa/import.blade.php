    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="modalFormLabel">{{ __('Upload siswa') }}</h5>
            ...
            <div class="modal-footer">
                <a class="btn btn-success" href="{{ asset('assets/template/template-excel.xlsx') }}"
                    download="template-excel.xlsx">{{ __('Download Format') }}</a>
