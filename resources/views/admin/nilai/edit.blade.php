    ...
    <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalEditNilai{{$nilai->id}}">Edit</button>

    <div class="modal fade" id="modalEditNilai{{$nilai->id}}" tabindex="-1" role="dialog" aria-labelledby="modalEditNilaiLabel" aria-hidden="true">
            ...
            <form>
                <div class="col-12 d-flex">
                  <div class="mb-3 col-6 px-2">
                    ...
                    <select class="form-select" name="id_semester" id="id_semester">
                      ...
                      <option value="{{$semester->id}}" {{ $semester->id == $nilai->id_semester ? 'selected' : '' }}>{{$semester->nama}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="mb-3 col-6 px-2">
                    ...
                    <select class="form-select" name="id_mapel" id="id_mapel">
                      ...
                      <option value="{{$mapel->id}}" {{ $mapel->id == $nilai->id_mapel ? 'selected' : '' }}>{{$mapel->nama}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                <div class="col-12 d-flex">
                  <div class="mb-3 col-12 px-2">
                    ...
                    <select class="form-select" name="id_guru" id="id_guru">
                      ...
                      <option value="{{$guru->id}}" {{ $guru->id == $nilai->id_guru ? 'selected' : '' }}>{{$guru->nama}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                <div class="col-12 d-flex">
                  <div class="mb-3 col-6 px-2">
                    ...
                    <input type="number" class="form-control" id="tugas" name="tugas" value="{{$nilai->tugas}}"/>
                  </div>

                  <div class="mb-3 col-6 px-2">
                    <label class="form-label">UTS</label>
                    <input type="number" class="form-control" id="uts" name="uts" value="{{$nilai->uts}}" />
                  </div>
                </div>
                <div class="col-12 d-flex">
                  <div class="mb-3 col-12 px-2">
                    <label class="form-label">UAS</label>
                    <input type="number" class="form-control" id="uas" name="uas" value="{{$nilai->uas}}"/>
                  </div>
                </div>
                <div class="col-12 d-flex">
                  <div class="mb-3 col-12 px-2">
