...
data-bs-target=".bd-example-modal-sm{{ $pengumuman->id }}">
Hapus
</a>
<!-- Modal -->
<div class="modal fade bd-example-modal-sm{{ $pengumuman->id }}" tabindex="-1" role="dialog" aria-hidden="">
<div class="modal-dialog ">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title"><strong>Hapus @yield('title')</strong></h5>
