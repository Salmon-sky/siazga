    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-3">
                <form action="POST">
                    <div class="card">
                        <img id="avatarPreview" src="{{ asset('assets/file/' . $user->img) }}" width="300"
                            class="img img-fluid" alt="Avatar">

                        <button class="btn btn-success" type="button"
                            onclick="document.getElementById('fileInput').click()">Ubah Foto</button>
                            ...
                            <div class="mb-3 col-6 px-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="no_hp" id="no_hp"
                                        placeholder="no_hp" value="{{ $user->no_hp }}" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="col-12 d-flex">
                                <div class="mb-3 col-12 px-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="id_kelas" id="id_kelas" disabled>
                                            @foreach ($kelass as $kelas)
                                                <option value="{{ $kelas->id }}"
                                                    {{ $kelas->id == $user->id_kelas ? 'selected' : '' }}>
                                                    {{ $kelas->kelas }} {{ $kelas->nama }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <!-- Input hidden untuk mengirimkan nilai kelas yang dipilih -->
